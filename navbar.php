...
<div style="text-align: center; margin-top: 20px; font-size: 20px; font-style: bold; color: red;">
	<?php
	if($_GET['page'] == 'payments') echo "NHẬT KÝ GIAO DỊCH";
	elseif($_GET['page'] == 'webhistorys') echo "NHẬT KÝ WEBSITE";
	elseif($_GET['page'] == 'serverlog') echo "NHẬT KÝ MÁY CHỦ";
	elseif($_GET['page'] == 'sysclient') echo "QUẢN LÝ MÁY TRẠM";
